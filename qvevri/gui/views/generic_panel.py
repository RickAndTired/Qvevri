...
LINKS = {
    "floss": "https://qvevri.net/games/?q=&fully-libre-filter=on&sort-by-popularity=on",
    "f2p": (
        "https://qvevri.net/games/?q=&all-free=on&free-filter=on&freetoplay-filter=on"
        "&pwyw-filter=on&sort-by-popularity=on"
    ),
    "donate": "https://qvevri.net/donate",
    "forums": "https://forums.qvevri.net/",
    "discord": "https://discord.gg/Pnt5CuY",
    "irc": "irc://irc.freenode.org:6667/qvevri",
}
...
class GenericPanel(Gtk.Fixed):
    ...
    def place_content(self):
        ...
        self.put(self.get_qvevri_links(), 40, 80)
    ...
    def get_qvevri_links(self):
        box = Gtk.VBox(spacing=6, visible=True)

        donate_button = get_link_button("Support Qvevri!")
