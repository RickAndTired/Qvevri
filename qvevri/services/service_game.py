"""Communicates between third party services games and Qvevri games"""
...
class ServiceGame:
    ...
    def __init__(self):
        ...
        self.game_id = None  # Internal Qvevri ID
    ...
    def new_from_qvevri_id(cls, game_id):
        """Create a ServiceGame from its Qvevri ID"""
        service_game = cls()
    ...
    @property
    def config_id(self):
        """Returns the ID to use for the qvevri config file"""
