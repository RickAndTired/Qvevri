...
from qvevri.installer.errors import ScriptingError

from qvevri import runtime
from qvevri.cache import get_cache_path
from qvevri.util import extract, disks, system
from qvevri.util.fileio import EvilConfigParser, MultiOrderedDict
from qvevri.util.log import logger
from qvevri.util.wine.wine import get_wine_version_exe, WINE_DEFAULT_ARCH
from qvevri.util import selective_merge

from qvevri.runners import import_task
...
class CommandsMixin:
    ...
    def insert_disc(self, data):
        ...
        message += (
            "\n\nQvevri is looking for a mounted disk drive or image \n"
    ...
    def rename(self, params):
        ...
        temp_dir = os.path.join(dst_dir, "qvevri_rename_temp")
