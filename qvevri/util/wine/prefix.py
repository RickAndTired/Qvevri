...
from qvevri.util import joypad, system
from qvevri.util.xdgshortcuts import get_xdg_entry
...
class WinePrefixManager:
    ...
    def set_virtual_desktop(self, enabled):
        ...
        The Qvevri virtual desktop is refered to as 'WineDesktop', in Wine the
