...
from qvevri import api, pga, runtime, settings
...
class ClientLoginDialog(GtkBuilderDialog):
    glade_file = "dialog-qvevri-login.ui"
    dialog_object = "qvevri-login"
    __gsignals__ = {
...
class WineNotInstalledWarning(DontShowAgainDialog):
    ...
    def __init__(self, parent=None):
        super().__init__(
            ...
            "Wine builds from Qvevri will have all required dependencies.\n\nPlease "
            "follow the instructions given in the <a "
            "href='https://github.com/qvevri/qvevri/wiki/Wine-Dependencies'>Qvevri Wiki</a> to "
            "install Wine.",
            parent=parent,
        )
