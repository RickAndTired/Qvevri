...
class TestPersonnalGameArchive(DatabaseTester):
    def setUp(self):
        ...
        self.game_id = pga.add_game(name="QvevriTest", runner="Linux")

    def test_add_game(self):
        game_list = pga.get_games()
        game_names = [item['name'] for item in game_list]
        self.assertTrue("QvevriTest" in game_names)
    ...
    def test_get_game_list(self):
        ...
        self.assertEqual(game_list[0]['slug'], 'qvevritest')
        self.assertEqual(game_list[0]['name'], 'QvevriTest')
