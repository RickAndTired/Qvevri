...
from qvevri import pga, settings, runtime
from qvevri.config import QvevriConfig
from qvevri.gui import dialogs
from qvevri.command import MonitoredCommand
from qvevri.util.extract import extract_archive, ExtractFailure
from qvevri.util.log import logger
from qvevri.util import system
from qvevri.util.http import Request
from qvevri.runners import RunnerInstallationError
...
class Runner:
    ...
    def default_config(self):
        return QvevriConfig(runner_slug=self.name)
    ...
    def get_runtime_env(self):
        ...
        (Notably for Qvevri wine builds)
    ...
    def install_dialog(self):
        ...
        if Gtk.ResponseType.YES == dialog.result:
            ...
            from qvevri.gui.dialogs.runners import simple_downloader
            from qvevri.gui.dialogs import ErrorDialog
            try:
    ...
    def extract(self, archive=None, dest=None, merge_single=None, callback=None):
        ...
        if self.name == "wine":
            ...
            from qvevri.util.wine.wine import get_wine_versions
