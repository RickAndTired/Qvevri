...
from qvevri.util.graphics.xrandr import LegacyDisplayManager, change_resolution, get_outputs
from qvevri.util.graphics.displayconfig import MutterDisplayManager
...
def get_compositor_commands():
    """Nominated for the worst function in qvevri"""
