...
from qvevri.util import datapath, system, resources
from qvevri.util.strings import split_arguments
from qvevri import pga, settings
...
class web(Runner):
    ...
    runner_options = [
        ...
        },
        {
            ...
            "help": (
                ...
                "If left blank, Qvevri will launch your default browser (xdg-open)."
            ),
        },
        {
    ...
    def play(self):
        ...
        if self.runner_config.get("external_browser"):
            # is it possible to disable qvevri runtime here?
