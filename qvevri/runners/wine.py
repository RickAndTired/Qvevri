...
from qvevri import runtime
from qvevri.settings import RUNTIME_DIR
from qvevri.exceptions import GameConfigError
from qvevri.gui.dialogs import FileDialog
from qvevri.runners.runner import Runner
from qvevri.util.jobs import thread_safe_call
from qvevri.util import system
from qvevri.util.log import logger
from qvevri.util.strings import parse_version, split_arguments
from qvevri.util.display import DISPLAY_MANAGER
from qvevri.util.graphics.vkquery import is_vulkan_supported
from qvevri.util.wine.prefix import WinePrefixManager
from qvevri.util.wine.x360ce import X360ce
from qvevri.util.wine import dxvk
from qvevri.util.wine import nine
from qvevri.util.wine.wine import (
    POL_PATH,
    WINE_DIR,
    WINE_PATHS,
    detect_arch,
...
from qvevri.runners.commands.wine import (  # noqa pylint: disable=unused-import
    create_prefix,
    delete_registry_key,
    eject_disc,
    set_regedit,
...
class wine(Runner):
    ...
    def get_runtime_env(self):
        """Return runtime environment variables with path to wine for Qvevri builds"""
        wine_path = self.get_executable()
        wine_root = None
        if WINE_DIR:
