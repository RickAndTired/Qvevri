...
from qvevri.runners import wine
...
from qvevri.util.steam.config import read_config
from qvevri.util.steam.appmanifest import get_path_from_appmanifest
from qvevri.util.wine.registry import WineRegistry
from qvevri.util.wine.wine import WINE_DEFAULT_ARCH
...
STEAM_INSTALLER_URL = (
    "https://qvevri.nyc3.cdn.digitaloceanspaces.com/runners/winesteam/SteamSetup.exe"
)
        ...
        winesteam_options = [
            {
                ...
                "help": (
                    ...
                    "By default, Qvevri will look for a Windows Steam "
