...
from qvevri.util.graphics import glxinfo
from qvevri.util.graphics import vkquery
from qvevri.util.disks import get_drive_for_path

# Linux components used by qvevri
SYSTEM_COMPONENTS = {
    "COMMANDS": [
        "xrandr",
        "fuser",
...
class LinuxSystem:
    ...
    def get_arch():
        ...
        with the supported architectures from the Qvevri API
        """
