...
from qvevri.gui.widgets.utils import get_icon, get_pixbuf, get_main_window
from qvevri.gui.widgets.notifications import send_notification
from qvevri.services import get_services
from qvevri.settings import read_setting, write_setting
...
class ServiceSyncBox(Gtk.Box):
    ...
    def on_sync_button_clicked(self, _button, sync_with_qvevri_method):
...
class SyncServiceWindow(Gtk.ApplicationWindow):
    def __init__(self, application):
        ...
        self.set_default_icon_name("qvevri")
