...
class QvevriStatusIcon:
    ...
    def create(self):
        ...
        if APP_INDICATOR_SUPPORTED:
            return AppIndicator.Indicator.new("net.qvevri.Qvevri",
                                              "qvevri",
                                              AppIndicator.IndicatorCategory.APPLICATION_STATUS)
        return QvevriTray(self.application)
...
class QvevriTray(Gtk.StatusIcon):
    """Qvevri tray icon"""

    def __init__(self, application, **_kwargs):
        super().__init__()
        self.set_tooltip_text("Qvevri")
        self.set_visible(True)
        self.application = application
        self.set_from_icon_name("qvevri")
