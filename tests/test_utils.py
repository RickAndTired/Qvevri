...
from qvevri.util.steam import vdf
from qvevri.util import strings
from qvevri.util import fileio
...
class TestStringUtils(TestCase):
    def test_add_url_tags(self):
        ...
        self.assertEqual(
            strings.add_url_tags("foo http://qvevri.net bar"),
            "foo <a href=\"http://qvevri.net\">http://qvevri.net</a> bar"
        )
        self.assertEqual(
            strings.add_url_tags("http://qvevri.net"),
            "<a href=\"http://qvevri.net\">http://qvevri.net</a>"
        )
        text = "foo http://qvevri.net bar http://strycore.com"
        expected = (
            'foo <a href="http://qvevri.net">http://qvevri.net</a> '
