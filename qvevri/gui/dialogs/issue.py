...
from qvevri.gui.dialogs import NoticeDialog
from qvevri.util.linux import gather_system_info
...
class IssueReportWindow(BaseApplicationWindow):
    ...
    def __init__(self, application):
        ...
        issue_entry_label = Gtk.Label(
            ...
            "This information will be sent the Qvevri team along with your system information."
    ...
    def on_folder_selected(self, dialog, response):
        ...
        if not target_path:
            return
        issue_path = os.path.join(target_path, "qvevri-issue-report.json")
