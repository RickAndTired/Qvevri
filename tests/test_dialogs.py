...
from qvevri.startup import init_qvevri
...
from qvevri.gui.views.store import sort_func
...
class TestGameDialog(TestCase):
    def setUp(self):
        init_qvevri()
        qvevri_application = Application()
        qvevri_window = qvevri_application.window
        self.dlg = AddGameDialog(qvevri_window)
    ...
    def test_changing_runner_sets_new_config(self):
        ...
        self.assertEqual(self.dlg.qvevri_config.runner_slug, 'linux')
