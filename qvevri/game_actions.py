...
from qvevri.gui.widgets.utils import open_uri
from qvevri.gui.config.add_game import AddGameDialog
from qvevri.gui.config.edit_game import EditGameConfigDialog
from qvevri.gui.installerwindow import InstallerWindow
from qvevri.gui.dialogs.uninstall_game import UninstallGameDialog
from qvevri.gui.dialogs.log import LogWindow
from qvevri.util.system import path_exists
...
#            ),
    ...
    def on_view_game(self, _widget):
        """Callback to open a game on qvevri.net"""
        open_uri("https://qvevri.net/games/%s" % self.game.slug)
