...
from qvevri.runners import NonInstallableRunnerError
...
from qvevri.util.steam.config import get_default_acf, read_config
from qvevri.util.steam.vdf import to_vdf
from qvevri.util.steam.appmanifest import get_path_from_appmanifest
...
class steam(Runner):
    ...
    runner_options = [
        {
            ...
            "help": (
                ...
                "(only if Steam was started by Qvevri)"
            ),
        },
        {
        ...
        },
        {
            ...
            "help": (
                ...
                "Make sure you disabled Qvevri Runtime and "
        ...
        },
        {
            ...
            "help": (
                ...
                "Make sure Qvevri Runtime is disabled and "
    ...
    def install(self, version=None, downloader=None, callback=None):
        raise NonInstallableRunnerError(
            "Steam for Linux installation is not handled by Qvevri.\n"
            "Please go to "
    ...
    def play(self):
        ...
        if self.game_config.get("run_without_steam") and binary_path:
            ...
            # Get current steam pid to act as the root pid instead of qvevri
