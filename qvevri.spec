...
%global appid net.qvevri.Qvevri
...
URL:            http://qvevri.net
Source0:        http://qvevri.net/releases/qvevri_%{version}.tar.xz
...
%description
Qvevri is a gaming platform for GNU/Linux. Its goal is to make
...
%{_datadir}/icons/hicolor/16x16/apps/qvevri.png
%{_datadir}/icons/hicolor/22x22/apps/qvevri.png
