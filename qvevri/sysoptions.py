...
from qvevri.util.display import USE_DRI_PRIME, DISPLAY_MANAGER
...
#        "condition": system.LINUX_SYSTEM.is_feature_supported("GAMEMODE"),
    ...
    },
    {
        ...
        "default": os.path.expanduser("~/.local/share/qvevri/programs"),
        "scope": ["runner", "system"],
        "advanced": True,
        "help": "The default folder where you install your programs."
    },
    {
        "option": "disable_runtime",
        "type": "bool",
        "label": "Disable Qvevri Runtime",
        "default": False,
        "advanced": True,
        "help": (
            "The Qvevri Runtime loads some libraries before running the "
