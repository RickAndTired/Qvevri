...
def get_wrapper_script_location():
    """Return absolute path of qvevri-wrapper script"""
    wrapper_relpath = "share/qvevri/bin/qvevri-wrapper"
    candidates = [
    ...
    raise FileNotFoundError("Couldn't find qvevri-wrapper script in any of the expected locations")
